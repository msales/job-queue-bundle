...
class StatisticsListener
{
    public function postGenerateSchema(GenerateSchemaEventArgs $event)
    {
        ...
        $table->addColumn('job_id', 'bigint', ['nullable' => false, 'unsigned' => true]);
        $table->addColumn('characteristic', 'string', ['length' => 30, 'nullable' => false]);
        $table->addColumn('createdAt', 'datetime', ['nullable' => false]);
        $table->addColumn('charValue', 'float', ['nullable' => false]);
